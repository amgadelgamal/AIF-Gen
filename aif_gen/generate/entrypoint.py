...
async def main() -> None:
    ...
    prompts = []
    task_prompt = generate_mock_task_prompt(task)
    response_prompt = generate_mock_response_prompt(task, task_prompt, args.num_samples)
    prompts.append(task_prompt)
    prompts.append(response_prompt)
...
def generate_mock_task_prompt(task: AlignmentTask) -> str:
...
def generate_mock_response_prompt(
    task: AlignmentTask, task_prompt: str, num_samples: int
) -> str:
