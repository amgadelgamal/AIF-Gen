...
import benchmarks.COPR.trlx.utils.logging as logging
...
from benchmarks.COPR.trlx.pipeline.dpo_pipeline import DPOPipeline
...
from benchmarks.COPR.trlx.utils.modeling import logprobs_of_labels
...
@register_trainer('AccelerateDPOTrainer')
class AccelerateDPOTrainer(AccelerateRLTrainer):
    ...
    def loss(self, batch):
        ...
        loss = -torch.sigmoid(beta * ratio_w - beta * ratio_l).log().mean()
