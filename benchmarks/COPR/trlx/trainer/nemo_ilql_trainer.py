...
from benchmarks.COPR.trlx.models.modeling_ilql import ILQLConfig
from benchmarks.COPR.trlx.models.modeling_nemo_ilql import ILQLGPT
...
from benchmarks.COPR.trlx.trainer.accelerate_ilql_trainer import (
    make_experience,
)
...
class NeMoILQLTrainer(BaseRLTrainer):
    ...
    def make_experience(self, samples, rewards, max_length=2048):
        ...
        self.store = make_experience(
            samples, rewards, self.tokenizer, max_length, verbose
        )
