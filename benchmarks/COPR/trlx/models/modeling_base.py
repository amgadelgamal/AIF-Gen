    ...
    def from_pretrained(  # noqa: max-complexity
        ...
        **kwargs,
        ...
        if isinstance(pretrained_model_name_or_path, str):
            ...
            bin_filename = base_path / 'pytorch_model.bin'
            safe_filename = base_path / 'model.safetensors'
            sharded_index_filename = base_path / 'pytorch_model.bin.index.json'
            is_sharded = False

            if bin_filename.exists():
                filename = str(bin_filename)
            elif safe_filename.exists():
                ...
                try:
                    ...
                    try:
                        ...
                        if os.path.exists(str(sharded_index_filename)):
                            index_file_name = str(sharded_index_filename)
                        else:
