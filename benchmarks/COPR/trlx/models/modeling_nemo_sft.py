...
from benchmarks.COPR.trlx.models.modeling_nemo_ilql import (
...
class SFTGPT(MegatronGPTModel):
    ...
    def build_attention_mask_and_position_ids(
        ...
        attention_mask = torch.tril(
            torch.ones((1, seq_length, seq_length), device=data.device)
        ...
        def fwd_output_and_loss_func(
            ...
            if parallel_state.get_pipeline_model_parallel_world_size() == 1:
                ...
                attention_mask, position_ids = (
                    self.build_attention_mask_and_position_ids(data=input_ids)
                )
            else:
    ...
    def generate(
        ...
        if sampling_params is None:
            sampling_params = {
                ...
                'repetition_penalty': self.sft_config.gen_kwargs.get(
