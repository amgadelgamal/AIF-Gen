...
from benchmarks.COPR.trlx.data.method_configs import MethodConfig, get_method
...
class ModelConfig:
    ...
    cache_dir: Optional[str] = os.environ.get('SCRATCH') + '/TRLX/model_cache'
...
class TrainConfig:
    ...
    )  # Extra keyword arguments for the trainer
