...
from benchmarks.COPR.trlx.models.modeling_ppo import PPOConfig
...
def default_ilql_config():
    return TRLConfig(
        ...
        scheduler=SchedulerConfig(
            ...
            kwargs=dict(T_max=1e12, eta_min=5.0e-5),  # train.total_steps
        ),
        method=ILQLConfig(
            name='ilqlconfig',
            tau=0.7,
...
def default_sft_config():
    return TRLConfig(
        ...
        scheduler=SchedulerConfig(
            name='cosine_annealing',
            kwargs=dict(T_max=1e12, eta_min=1.0e-4),  # train.total_steps
        ),
        method=SFTConfig(
            name='sftconfig',
