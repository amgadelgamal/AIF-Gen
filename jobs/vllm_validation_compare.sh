...
uv run aif validate education_qna_hinted.json education_qna_hinted_70b_validation.json --model meta-llama/Meta-Llama-3-8B-Instruct &

echo "Running validation on gpt-4o-mini generated data..."
uv run aif validate "$SCRATCH/education_qna_hinted.json" education_qna_hinted_4omini_validation.json --model meta-llama/Meta-Llama-3-8B-Instruct &
wait
